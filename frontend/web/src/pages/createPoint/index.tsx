...
const CreatePoint = () => {
	...
	useEffect(()=>{ //Pegar posicao inicial
	...
	function handleMapClick(event:LeafletMouseEvent){
		setSelectedPosition([
			event.latlng.lat,
			event.latlng.lng]) //Pegar latitude e longitude
	}

	function handleInptChange(event:ChangeEvent<HTMLInputElement>){
		const {name, value} = event.target 
		//Quando temos muitos inputs sendo alterados numa mesma funcao de handle
		//Podemos desestruturar dessa forma 
	...
	async function handleSubmit(event: FormEvent){
		...
		alert("Ponto de coleta enviado com sucesso")
